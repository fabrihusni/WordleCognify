...
public class Board : MonoBehaviour
{
    ...
    {
        TextAsset textFile = Resources.Load("Palabras5LetrasSoluciones") as TextAsset;
        solutions = textFile.text.Split(SEPARATOR, System.StringSplitOptions.None);

        textFile = Resources.Load("Palabras5Letras") as TextAsset;
    ...
    private void OnEnable()
    {
        ...
        MostrarPalabra.SetActive(false);
    }
